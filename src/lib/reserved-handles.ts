...
const SYSTEM_NAMES_LIST = [
  ...
  // Generic AI-authorship tags. Blocked so nobody registers one and poses as
  // "official AI-generated content"; entity-specific AI names live in PRERESERVED.
  "agent-generated",
  "agentgenerated",
  "ai-agent",
  "aiagent",
...
const PRERESERVED_NAMES_LIST = [
  ...
  // AI coding agents, assistants, and CLIs, including the literal GitHub bot /
  // commit identities they sign work with (devin-ai-integration, coderabbitai,
  // cursoragent, google-labs-jules, gemini-code-assist, sweep-ai, and so on).
  "aider",
  "amazon-q",
  "amazonq",
  "antigravity",
  ...
  // AI companies and labs (the 2024-2026 wave, beyond the majors above).
  "01-ai",
  "01ai",
  "aleph-alpha",
  "alephalpha",
  ...
  // More AI products, models, and chat assistants.
  "chatglm",
  "codestral",
  "command-r",
  "commandr",
  ...
  // AI creative, media, voice, and video tools.
  "assembly-ai",
  "assemblyai",
  "automatic1111",
  "capcut",
